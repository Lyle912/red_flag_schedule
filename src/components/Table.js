...
export default function DenseTable({ filter }) {
  ...
  const exportPDF = (rows) => {
    ...
    const title = "RF-A 21-2 Schedule (MSOEv5)";
    const headers = [
